...
HRESULT CTexture::Init( IDirect3DDevice9 *pd3dDevice, char* fileName, CPack* pPack  )
{
	HRESULT hr = S_OK;
...
HRESULT CTexLibrary::Init( LPDIRECT3DDEVICE9 pd3dDevice )
{
	HRESULT hr = S_OK;
...
LPDIRECT3DTEXTURE9 CTexLibrary::GetTexture( DWORD id )
{
	if( id < 0 )
	{
		return NULL;
