...
HRESULT CIGA3D_UI_Element::Init( LPDIRECT3DDEVICE8 pd3dDevice )
{
...
//设置使用的纹理
void CIGA3D_UI_Element::SetTexture( LPDIRECT3DTEXTURE8 pTex )
{
	m_pTex = pTex;
}
...
HRESULT CUI_Tex::Init( LPDIRECT3DDEVICE8 pd3dDevice )
{
	m_pd3dDevice = pd3dDevice;
...
LPDIRECT3DTEXTURE8 CUI_Tex::GetTexture( int id )
{
	if( id == 0 )
	{
		return m_pTex;
...
HRESULT CButtom::Init( LPDIRECT3DDEVICE8 pd3dDevice, LPFUN pFun )
{
	m_pd3dDevice = pd3dDevice;
	m_pProcFun   = pFun;
