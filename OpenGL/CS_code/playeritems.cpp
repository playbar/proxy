...
Program:	BuNnY XtReMe DLL 

Converted By: NiNJA & G3NoCiD3 for cs 1.6 use

File:	cvar.cpp

Function:	Has alot of the cvars and different features registered here

Description:	Has alot of the different features and commands here

Author:	   Paul Upton, Tad, Unknown others

Environment:	Visual Basic Studio 6 c++ 320mb RAM, Windows XP

Notes:	This is Pauls and Snipity's cvar.cpp file

Revisions:	5/6/03 1:54am added Title
...
bool PlayerItems::canswitch()
{
	if(currentSlot==1){
		if(slot1Index!=-1){
			HlWeaponInfo& Rifle = weaponList[slot1Index]; 
			return (Rifle.iClip>0);
		}
	}
	return false;
}
