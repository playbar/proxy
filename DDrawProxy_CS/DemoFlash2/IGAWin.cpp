	...
	LRESULT CALLBACK   IGAWndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
	{
		...
		for( int i = 0; i <MAX_IGA_HOOK_WIN ;i++)
		{
			...
			{			
				...
				{
					::OutputDebugString("sendmessage xx");
					if ( NULL != s_pFunShow )
					{							
