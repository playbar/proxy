...
{
	CString strOpenFilter = "图象文件|*.bmp; *.dib; *.gif; *.jpg; *.jpe; *.jpeg; *.pcx; *.tga; *.tif; *.tiff|位图文件 (*.bmp;*.dib)|*.bmp; *.dib|GIF文件 (*.gif)|*.gif|JPEG文件 (*.jpg;*.jpe;*.jpeg)|*.jpg; *.jpe; *.jpeg|PCX文件 (*.pcx)|*.pcx|TGA文件 (*.tga)|*.tga|TIFF文件 (*.tif;*.tiff)|*.tif; *.tiff|All Files (*.*)|*.*||";
