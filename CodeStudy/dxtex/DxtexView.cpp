...
HRESULT CDxtexView::RenderScene(VOID)
{
	...
	SVertex verteices[] = 
	{
		{ 120,	120,		0.0f, 1.0f,0xffffffff,	0.0f, 0.0f },
		{ 250, 120,		0.0f, 1.0f,0xffffffff,	1.0f, 0.0f },
		{ 250, 250,	0.0f, 1.0f,0xffffffff,	1.0f, 1.0f },
		{ 120,	250,	0.0f, 1.0f,0xffffffff,	0.0f, 1.0f }
	};
	...
	pd3ddev->GetVertexDeclaration( &pDecl );  // Preserve the sprite's current vertex decl

	pd3ddev->SetFVF(SVertex::_fvf);
	pd3ddev->DrawPrimitiveUP( D3DPT_TRIANGLEFAN, 2, verteices, sizeof(SVertex) );
