...
protected:
	...
	BITMAPINFOHEADER    m_bmpHeadInfo; //standard header
	CXIMAGEINFO			m_stImgInfo; //extended information
	BYTE*				m_pSelection;	//selected region
	BYTE*				m_pAlpha; //alpha channel
	CxImage**			m_ppLayers; //generic layers
	CxImage**			m_ppFrames;
	//@}
};
