...
public:
    ...
    HRESULT     OnCreateDevice( LPDIRECT3DDEVICE8 pd3dDevice );
    ...
    IDirect3DStateBlock8* m_pStateBlock;
...
public:
    ...
    virtual void Render( IDirect3DDevice8* pd3dDevice, float fElapsedTime ) { };
...
public:
    ...
    virtual void RenderCandidateReadingWindow( IDirect3DDevice8* pd3dDevice, float fElapsedTime, bool bReading );
    virtual void RenderComposition( IDirect3DDevice8* pd3dDevice, float fElapsedTime );
    virtual void RenderIndicator( IDirect3DDevice8* pd3dDevice, float fElapsedTime );
