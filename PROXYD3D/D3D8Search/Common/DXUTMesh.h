...
public:
    ...
    IDirect3DVertexDeclaration8* m_pDecl;
    ...
    IDirect3DBaseTexture8** m_pTextures;
...
public:
    ...
    HRESULT SetVertexDecl( LPDIRECT3DDEVICE8 pd3dDevice, const D3DVERTEXELEMENT8 *pDecl, 
    ...
    HRESULT Create( LPDIRECT3DDEVICE8 pd3dDevice, LPCWSTR strFilename );
    HRESULT Create( LPDIRECT3DDEVICE8 pd3dDevice, LPD3DXFILEDATA pFileData );
	HRESULT Create( LPDIRECT3DDEVICE8 pd3dDevice, ID3DXMesh* pInMesh, D3DXMATERIAL* pd3dxMaterials, DWORD dwMaterials );
    HRESULT CreateMaterials( LPCWSTR strPath, IDirect3DDevice8 *pd3dDevice, D3DXMATERIAL* d3dxMtrls, DWORD dwNumMaterials );
    HRESULT Destroy();
...
{
    HRESULT LoadMesh( LPDIRECT3DDEVICE8 pd3dDevice, LPD3DXFILEDATA pFileData, 
