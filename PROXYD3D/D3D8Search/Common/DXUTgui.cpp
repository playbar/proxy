...
//--------------------------------------------------------------------------------------
HRESULT CDXUTDialogResourceManager::OnCreateDevice( LPDIRECT3DDEVICE8 pd3dDevice )
{
    HRESULT hr = S_OK;
    int i=0;
...
{   
    ...
    IDirect3DDevice8* pd3dDevice = m_pManager->GetD3DDevice();
...
HRESULT CDXUTDialog::DrawRect( RECT* pRect, D3DCOLOR color )
{
    ...
    IDirect3DVertexDeclaration8 *pDecl = NULL;
...
//--------------------------------------------------------------------------------------
void CDXUTStatic::Render( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{    
    if( m_bVisible == false )
        return;
...
//--------------------------------------------------------------------------------------
void CDXUTButton::Render( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{
    int nOffsetX = 0;
    int nOffsetY = 0;
...
//--------------------------------------------------------------------------------------
void CDXUTCheckBox::Render( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{
    DXUT_CONTROL_STATE iState = DXUT_STATE_NORMAL;
...
//--------------------------------------------------------------------------------------
void CDXUTComboBox::Render( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{
    DXUT_CONTROL_STATE iState = DXUT_STATE_NORMAL;
...
//--------------------------------------------------------------------------------------
void CDXUTSlider::Render( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{
    int nOffsetX = 0;
    int nOffsetY = 0;
...
//--------------------------------------------------------------------------------------
void CDXUTScrollBar::Render( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{
...
//--------------------------------------------------------------------------------------
void CDXUTListBox::Render( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{
    if( m_bVisible == false )
        return;
...
//--------------------------------------------------------------------------------------
void CDXUTEditBox::Render( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{
    if( m_bVisible == false )
        return;
...
void CDXUTIMEEditBox::SendCompString()
{
	...
	//g_istrlen = lstrlenW( s_CompString.GetBuffer() );
	//g_istrCurLen = 0;
	//g_bIm = true;
...
{
	//DXTrace(__FILE__,__LINE__, S_OK, L"CDXUTIMEEditBox::StaticMsgProc ..............", FALSE);
    HIMC hImc;
...
//--------------------------------------------------------------------------------------
void CDXUTIMEEditBox::RenderCandidateReadingWindow( IDirect3DDevice8* pd3dDevice, float fElapsedTime, bool bReading )
{
    RECT rc;
...
//--------------------------------------------------------------------------------------
void CDXUTIMEEditBox::RenderComposition( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{
...
//--------------------------------------------------------------------------------------
void CDXUTIMEEditBox::RenderIndicator( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{
...
//--------------------------------------------------------------------------------------
void CDXUTIMEEditBox::Render( IDirect3DDevice8* pd3dDevice, float fElapsedTime )
{
    if( m_bVisible == false )
        return;
