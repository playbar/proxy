...
HRESULT FlashPlayer::InitFlashOCX()
{
	...
	if (m_hFlashLibHandle != NULL)
	{
		...
		lResult = aDllGetClassObjectFunc(CLSID_ShockwaveFlash, IID_IClassFactory, (void**)&aClassFactory);
	...
	lResult = m_pOleObject->DoVerb(OLEIVERB_INPLACEACTIVATE, NULL, aClientSite, 0, NULL, NULL);
	aClientSite->Release();	
