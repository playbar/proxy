...
//IGA_IDirect3DSwapChain9*	gl_pmyIDirect3DSwapChain9;
//IGA_IDirect3DDevice9*		gl_pmyIDirect3DDevice9;
//IGA_IDirect3D9*				gl_pmyIDirect3D9;
...
IDirect3D9* WINAPI Direct3DCreate9(UINT SDKVersion)
{
	...
	IGA_IDirect3D9 *pmyIDirect3D9 = new IGA_IDirect3D9(pIDirect3D9_orig);
	
	// Return pointer to hooking Object instead of "real one"
	return pmyIDirect3D9;
}
