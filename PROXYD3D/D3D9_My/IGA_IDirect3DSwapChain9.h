...
class IGA_IDirect3DSwapChain9 : public IDirect3DSwapChain9
{
public:
    IGA_IDirect3DSwapChain9(IDirect3DSwapChain9* pOriginal, IDirect3DDevice9* pDevice);
    virtual ~IGA_IDirect3DSwapChain9(void);
