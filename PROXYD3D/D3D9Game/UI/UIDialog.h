...
#include "..\D3D\D3D.h"
#include "..\D3D\Base\D2D.h"
#include "..\GameDefine.h"
#include "../Table/UITextureTable.h"
...
public:
	...
	virtual bool Event( ST_UI_MSG * pMsg ) = 0;
};
...
public:
	...
	virtual bool Event( ST_UI_MSG * pMsg )
	{
		return false;
	}

	void SendMsg( ST_UI_MSG * pMsg );
...
public:
	...
	void InsertLine( TCHAR * szText, DWORD dwColor, DWORD dwFormat )
	{
		...
		while( szText[i] != 0 )
		{
			m_pVFont->m_pFont->DrawText( NULL, szText, i+1, &rect, DT_CALCRECT, 0xff000000 );
