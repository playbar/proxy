...
CDXUTIMEEditBox::CDXUTIMEEditBox( CDXUTDialog *pDialog )
{
	...
	//////////////////////////////////////////////////////////////////////////
	//extern bool g_bCOMPOSITION;
	//g_bCOMPOSITION = ! g_bCOMPOSITION;
	// HIMC hImc;
	////SHOWOUTPUTDEBUG( WM_INPUTLANGCHANGE );
...
HRESULT CDXUTIMEEditBox::StaticOnCreateDevice()
{
    ...
    ms_hImcDef = _ImmGetContext( DXUTGetHWND() );
    _ImmReleaseContext( DXUTGetHWND(), ms_hImcDef );
...
void CDXUTIMEEditBox::OnFocusIn()
{
    ...
    {
        _ImmAssociateContext( DXUTGetHWND(), ms_hImcDef );
        CheckToggleState();
    } 
	else
	{
...
{
	//SHOWOUTPUTDEBUG( CDXUTIMEEditBox::StaticMsgProc );
    HIMC hImc;
    if( !s_bEnableImeSystem )
        return false;
