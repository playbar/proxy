...
{
	g_DXUTState.SetInsideMainloop( bState );
}
...
{ 
	g_DXUTState.SetDeviceCreatedFunc( pCallbackDeviceCreated ); 
	g_DXUTState.SetDeviceCreatedFuncUserContext( pUserContext ); 
}

void DXUTSetCallbackDeviceReset( LPDXUTCALLBACKDEVICERESET pCallbackDeviceReset, void* pUserContext )  
{ 
	g_DXUTState.SetDeviceResetFunc( pCallbackDeviceReset ); 
	g_DXUTState.SetDeviceResetFuncUserContext( pUserContext ); 
}

void DXUTSetCallbackDeviceLost( LPDXUTCALLBACKDEVICELOST pCallbackDeviceLost, void* pUserContext )  
{ 
	g_DXUTState.SetDeviceLostFunc( pCallbackDeviceLost );  
	g_DXUTState.SetDeviceLostFuncUserContext( pUserContext ); 
}

void DXUTSetCallbackDeviceDestroyed( LPDXUTCALLBACKDEVICEDESTROYED pCallbackDeviceDestroyed, void* pUserContext )
{ 
	g_DXUTState.SetDeviceDestroyedFunc( pCallbackDeviceDestroyed );  
	g_DXUTState.SetDeviceDestroyedFuncUserContext( pUserContext ); 
}

void DXUTSetCallbackDeviceChanging( LPDXUTCALLBACKMODIFYDEVICESETTINGS pCallbackModifyDeviceSettings, void* pUserContext ) 
{ 
	g_DXUTState.SetModifyDeviceSettingsFunc( pCallbackModifyDeviceSettings ); 
	g_DXUTState.SetModifyDeviceSettingsFuncUserContext( pUserContext ); 
}

void DXUTSetCallbackFrameMove( LPDXUTCALLBACKFRAMEMOVE pCallbackFrameMove, void* pUserContext ) 
{ 
	g_DXUTState.SetFrameMoveFunc( pCallbackFrameMove ); 
	g_DXUTState.SetFrameMoveFuncUserContext( pUserContext ); 
}

void DXUTSetCallbackFrameRender( LPDXUTCALLBACKFRAMERENDER pCallbackFrameRender, void* pUserContext )  
{
	g_DXUTState.SetFrameRenderFunc( pCallbackFrameRender );  
	g_DXUTState.SetFrameRenderFuncUserContext( pUserContext ); 
}

void DXUTSetCallbackKeyboard( LPDXUTCALLBACKKEYBOARD pCallbackKeyboard, void* pUserContext )   
{
	g_DXUTState.SetKeyboardFunc( pCallbackKeyboard );  
	g_DXUTState.SetKeyboardFuncUserContext( pUserContext ); 
}

void DXUTSetCallbackMouse( LPDXUTCALLBACKMOUSE pCallbackMouse, bool bIncludeMouseMove, void* pUserContext )
{
	g_DXUTState.SetMouseFunc( pCallbackMouse ); 
	g_DXUTState.SetNotifyOnMouseMove( bIncludeMouseMove );  
	g_DXUTState.SetMouseFuncUserContext( pUserContext ); 
}

void DXUTSetCallbackMsgProc( LPDXUTCALLBACKMSGPROC pCallbackMsgProc, void* pUserContext )                  
{
	g_DXUTState.SetWindowMsgFunc( pCallbackMsgProc );  
	g_DXUTState.SetWindowMsgFuncUserContext( pUserContext ); 
}
...
{
    g_DXUTState.SetDXUTInitCalled( true );
    ...
    g_DXUTState.SetShowMsgBoxOnError( bShowMsgBoxOnError );
    g_DXUTState.SetHandleDefaultHotkeys( bHandleDefaultHotkeys );
    g_DXUTState.SetHandleAltEnter( bHandleAltEnter );
    ...
    g_DXUTState.SetDXUTInited( true );
        ...
        if( *strCmdLine == L'/' || *strCmdLine == L'-' )
        {
            ...
            if( DXUTIsNextArg( strCmdLine, L"adapter" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
                    ...
                    g_DXUTState.SetOverrideAdapterOrdinal( nAdapter );
                    continue;
                }
            }
            ...
            {
                g_DXUTState.SetOverrideWindowed( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, L"fullscreen" ) )
            {
                g_DXUTState.SetOverrideFullScreen( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, L"forcehal" ) )
            {
                g_DXUTState.SetOverrideForceHAL( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, L"forceref" ) )
            {
                g_DXUTState.SetOverrideForceREF( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, L"forcepurehwvp" ) )
            {
                g_DXUTState.SetOverrideForcePureHWVP( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, L"forcehwvp" ) )
            {
                g_DXUTState.SetOverrideForceHWVP( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, L"forceswvp" ) )
            {
                g_DXUTState.SetOverrideForceSWVP( true );
                continue;
            }
            ...
            if( DXUTIsNextArg( strCmdLine, L"forcevsync" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
                    ...
                    g_DXUTState.SetOverrideForceVsync( nOn );
                    continue;
                }
            }
            ...
            if( DXUTIsNextArg( strCmdLine, L"width" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
                    ...
                    g_DXUTState.SetOverrideWidth( nWidth );
                    continue;
                }
            }
            ...
            if( DXUTIsNextArg( strCmdLine, L"height" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
                    ...
                    g_DXUTState.SetOverrideHeight( nHeight );
                continue;
                }
            }
            ...
            if( DXUTIsNextArg( strCmdLine, L"startx" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
                    ...
                    g_DXUTState.SetOverrideStartX( nX );
                    continue;
                }
            }
            ...
            if( DXUTIsNextArg( strCmdLine, L"starty" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
                    ...
                    g_DXUTState.SetOverrideStartY( nY );
                    continue;
                }
            }
            ...
            if( DXUTIsNextArg( strCmdLine, L"constantframetime" ) )
            {
                ...
                g_DXUTState.SetOverrideConstantFrameTime( true );
                g_DXUTState.SetOverrideConstantTimePerFrame( fTimePerFrame );
            ...
            if( DXUTIsNextArg( strCmdLine, L"quitafterframe" ) )
            {
                if( DXUTGetCmdParam( strCmdLine, strFlag ) )
                {
                    ...
                    g_DXUTState.SetOverrideQuitAfterFrame( nFrame );
                    continue;
                }
            }
            ...
            {
                g_DXUTState.SetShowMsgBoxOnError( false );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, L"nostats" ) )
            {
                g_DXUTState.SetNoStats( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, L"relaunchmce" ) )
            {
                g_DXUTState.SetOverrideRelaunchMCE( true );
                continue;
            }

            if( DXUTIsNextArg( strCmdLine, L"automation" ) )
            {
                g_DXUTState.SetAutomation( true );
                continue;
            }
        }
                          ...
                          HICON hIcon, HMENU hMenu, int x, int y )
{
    ...
    if( DXUTGetHWNDFocus() == NULL )
    {
        ...
        g_DXUTState.SetHInstance( hInstance );
        ...
        if( g_DXUTState.GetOverrideStartX() != -1 )
            x = g_DXUTState.GetOverrideStartX();
        if( g_DXUTState.GetOverrideStartY() != -1 )
            y = g_DXUTState.GetOverrideStartY();

        g_DXUTState.SetWindowCreatedWithDefaultPositions( false );
        if( x == CW_USEDEFAULT && y == CW_USEDEFAULT )
            g_DXUTState.SetWindowCreatedWithDefaultPositions( true );

        // Find the window's initial size, but it might be changed later
        int nDefaultWidth = 640;
        int nDefaultHeight = 480;
        if( g_DXUTState.GetOverrideWidth() != 0 )
            nDefaultWidth = g_DXUTState.GetOverrideWidth();
        if( g_DXUTState.GetOverrideHeight() != 0 )
            nDefaultHeight = g_DXUTState.GetOverrideHeight();
        SetRect( &rc, 0, 0, nDefaultWidth, nDefaultHeight );        
        AdjustWindowRect( &rc, WS_OVERLAPPEDWINDOW, ( hMenu != NULL ) ? true : false );

        WCHAR* strCachedWindowTitle = g_DXUTState.GetWindowTitle();
        ...
        g_DXUTState.SetWindowCreated( true );
        g_DXUTState.SetHWNDFocus( hWnd );
        g_DXUTState.SetHWNDDeviceFullScreen( hWnd );
        g_DXUTState.SetHWNDDeviceWindowed( hWnd );
    }
...
HRESULT DXUTSetWindow( HWND hWndFocus, HWND hWndDeviceFullScreen, HWND hWndDeviceWindowed, bool bHandleMessages )
{
    ...
    if( bHandleMessages )
    {
	/*	g_HookerMsg.SetWndHook( hWndFocus );
		if( g_HookerMsg.GetHook() == NULL)
		{
		 ...
		 //winProc = (LPWNDPROC)GetWindowLong(hWndFocus,GWLP_WNDPROC);
...
//	
//		//WCHAR text[256];
//		//wsprintf( text, L"winProc: %08x %08x", winProc ,(DWORD)nResult);
...
//            return DXUT_ERR_MSGBOX( L"SetWindowLongPtr", HRESULT_FROM_WIN32(dwError) );
    ...
    g_DXUTState.SetWindowCreatedWithDefaultPositions( false );
    g_DXUTState.SetWindowCreated( true );
    g_DXUTState.SetHWNDFocus( hWndFocus );
	g_DXUTState.SetHWNDDeviceFullScreen( hWndDeviceFullScreen );
    g_DXUTState.SetHWNDDeviceWindowed( hWndDeviceWindowed );
...
//--------------------------------------------------------------------------------------
HRESULT DXUTCreateDevice( UINT nAdapterOrdinal, bool bWindowed, 
                          int nSuggestedWidth, int nSuggestedHeight,
                          LPDXUTCALLBACKISDEVICEACCEPTABLE lpFunCallbackIsDeviceAcceptable,
                          LPDXUTCALLBACKMODIFYDEVICESETTINGS lpFunCallbackModifyDeviceSettings,
                          void* pUserContext )
{
    HRESULT hr = E_FAIL;
    ...
    g_DXUTState.SetIsDeviceAcceptableFunc( lpFunCallbackIsDeviceAcceptable );
    g_DXUTState.SetModifyDeviceSettingsFunc( lpFunCallbackModifyDeviceSettings );
    g_DXUTState.SetIsDeviceAcceptableFuncUserContext( pUserContext );
    g_DXUTState.SetModifyDeviceSettingsFuncUserContext( pUserContext );

    g_DXUTState.SetDeviceCreateCalled( true );

    // If DXUTCreateWindow() or DXUTSetWindow() has not already been called, 
    // then call DXUTCreateWindow() with the default parameters.         
    if( !g_DXUTState.GetWindowCreated() ) 
    {
        ...
        if( g_DXUTState.GetWindowCreateCalled() )
            return E_FAIL; 
    ...
    deviceSettings.AdapterOrdinal      = nAdapterOrdinal;
    ...
    if( g_DXUTState.GetOverrideWidth() != 0 )
        deviceSettings.pp.BackBufferWidth = g_DXUTState.GetOverrideWidth();
    if( g_DXUTState.GetOverrideHeight() != 0 )
        deviceSettings.pp.BackBufferHeight = g_DXUTState.GetOverrideHeight();

    if( g_DXUTState.GetOverrideAdapterOrdinal() != -1 )
        deviceSettings.AdapterOrdinal = g_DXUTState.GetOverrideAdapterOrdinal();

    if( g_DXUTState.GetOverrideFullScreen() )
    {
        deviceSettings.pp.Windowed = FALSE;
        if( g_DXUTState.GetOverrideWidth() == 0 && g_DXUTState.GetOverrideHeight() == 0 )
            matchOptions.eResolution = DXUTMT_IGNORE_INPUT;
    }
    if( g_DXUTState.GetOverrideWindowed() )
        deviceSettings.pp.Windowed = TRUE;

    if( g_DXUTState.GetOverrideForceHAL() )
    {
        deviceSettings.DeviceType = D3DDEVTYPE_HAL;
        matchOptions.eDeviceType = DXUTMT_PRESERVE_INPUT;
    }
    if( g_DXUTState.GetOverrideForceREF() )
    {
        deviceSettings.DeviceType = D3DDEVTYPE_REF;
        matchOptions.eDeviceType = DXUTMT_PRESERVE_INPUT;
    }

    if( g_DXUTState.GetOverrideForcePureHWVP() )
    {
...
HRESULT DXUTToggleFullScreen()
{
    ...
    UINT nWidth  = ( deviceSettings.pp.Windowed ) ? g_DXUTState.GetWindowBackBufferWidthAtModeChange() : g_DXUTState.GetFullScreenBackBufferWidthAtModeChange();
    UINT nHeight = ( deviceSettings.pp.Windowed ) ? g_DXUTState.GetWindowBackBufferHeightAtModeChange() : g_DXUTState.GetFullScreenBackBufferHeightAtModeChange();
...
CD3DEnumeration* DXUTPrepareEnumerationObject( bool bEnumerate )
{
    ...
    CD3DEnumeration* pd3dEnum = g_DXUTState.GetD3DEnumeration();
    if( pd3dEnum == NULL )
    {
        pd3dEnum = &g_CD3DEnumeration; 
        g_DXUTState.SetD3DEnumeration( pd3dEnum );
    ...
    if( bEnumerate )
    {
        ...
        IDirect3D9* pD3D = DXUTGetD3DObject();
        pd3dEnum->Enumerate( pD3D, g_DXUTState.GetIsDeviceAcceptableFunc(), g_DXUTState.GetIsDeviceAcceptableFuncUserContext() );
    }
...
{
    HRESULT hr;
    DXUTDeviceSettings* pOldDeviceSettings = g_DXUTState.GetCurrentDeviceSettings();
    ...
    LPDXUTCALLBACKMODIFYDEVICESETTINGS pCallbackModifyDeviceSettings = g_DXUTState.GetModifyDeviceSettingsFunc();
    if( pCallbackModifyDeviceSettings )
    {
        ...
        bool bContinue = pCallbackModifyDeviceSettings( pNewDeviceSettings, &caps, g_DXUTState.GetModifyDeviceSettingsFuncUserContext() );
        if( !bContinue )
        {
    ...
    g_DXUTState.SetCurrentDeviceSettings( pNewDeviceSettings );
    ...
    g_DXUTState.SetIgnoreSizeChange( true );
    ...
    if( pNewDeviceSettings->pp.Windowed )
    {
        ...
        if( pOldDeviceSettings && !pOldDeviceSettings->pp.Windowed )
        {
            ...
            g_DXUTState.SetFullScreenBackBufferWidthAtModeChange( pOldDeviceSettings->pp.BackBufferWidth );
            g_DXUTState.SetFullScreenBackBufferHeightAtModeChange( pOldDeviceSettings->pp.BackBufferHeight );

            // Restore windowed mode style
            SetWindowLong( DXUTGetHWNDDeviceWindowed(), GWL_STYLE, g_DXUTState.GetWindowedStyleAtModeChange() );
        }
        ...
        if( DXUTGetHWNDDeviceFullScreen() == DXUTGetHWNDDeviceWindowed() )
        {
            if( g_DXUTState.GetMenu() != NULL )
                SetMenu( DXUTGetHWNDDeviceWindowed(), g_DXUTState.GetMenu() );
        }
    }
    else 
    {
        ...
        if( pOldDeviceSettings == NULL || (pOldDeviceSettings && pOldDeviceSettings->pp.Windowed) )
        {
            ...
            WINDOWPLACEMENT* pwp = g_DXUTState.GetWindowedPlacement();
            ...
            g_DXUTState.SetTopmostWhileWindowed( bIsTopmost );
            ...
            g_DXUTState.SetWindowedStyleAtModeChange( dwStyle );
            if( pOldDeviceSettings )
            {
                g_DXUTState.SetWindowBackBufferWidthAtModeChange( pOldDeviceSettings->pp.BackBufferWidth );
                g_DXUTState.SetWindowBackBufferHeightAtModeChange( pOldDeviceSettings->pp.BackBufferHeight );
            }
        }
        ...
        pOldDeviceSettings->BehaviorFlags == pNewDeviceSettings->BehaviorFlags )
    {
        ...
        if( FAILED(hr) )
        {
            if( D3DERR_DEVICELOST == hr )
            {
                ...
                g_DXUTState.SetDeviceLost( true );
            }
            ...
            else // DXUTERR_RESETTINGDEVICE
            {
                ...
                g_DXUTState.SetCurrentDeviceSettings( pOldDeviceSettings );
    ...
    else
    {
        ...
        if( FAILED(hr) )
        {
            ...
            g_DXUTState.SetIgnoreSizeChange( false );
            return hr;
        }
    }
    ...
    DXUTAllowShortcutKeys( ( pNewDeviceSettings->pp.Windowed  ) ? g_DXUTState.GetAllowShortcutKeysWhenWindowed() : g_DXUTState.GetAllowShortcutKeysWhenFullscreen() );

    IDirect3D9* pD3D = DXUTGetD3DObject();
    HMONITOR hAdapterMonitor = pD3D->GetAdapterMonitor( pNewDeviceSettings->AdapterOrdinal );
    g_DXUTState.SetAdapterMonitor( hAdapterMonitor );
    ...
    if( pOldDeviceSettings && !pOldDeviceSettings->pp.Windowed && pNewDeviceSettings->pp.Windowed )
    {
        ...
        HWND hWndInsertAfter = g_DXUTState.GetTopmostWhileWindowed() ? HWND_TOPMOST : HWND_NOTOPMOST;
        ...
        !bKeepCurrentWindowSize )          // only resize if pp.BackbufferWidth/Height were not 0
    {
        ...
        if( IsIconic(DXUTGetHWNDDeviceWindowed()) )
        {
            ...
            else
            {
                ...
                RECT rcFrame = {0};
                AdjustWindowRect( &rcFrame, g_DXUTState.GetWindowedStyleAtModeChange(), g_DXUTState.GetMenu() != NULL );
    ...
    if( bNeedToResize ) 
    {
        ...
        if( bClipWindowToSingleAdapter )
        {
            ...
            AdjustWindowRect( &rcResizedWindow, GetWindowLong( DXUTGetHWNDDeviceWindowed(), GWL_STYLE ), g_DXUTState.GetMenu() != NULL );
        ...
        {      
            ...
            AdjustWindowRect( &rcWindow, GetWindowLong( DXUTGetHWNDDeviceWindowed(), GWL_STYLE ), g_DXUTState.GetMenu() != NULL );
    ...
    g_DXUTState.SetIgnoreSizeChange( false );
    DXUTPause( false, false );
    g_DXUTState.SetDeviceCreated( true );
...
LRESULT CALLBACK LowLevelKeyboardProc( int nCode, WPARAM wParam, LPARAM lParam )
{
	...
	{
		return CallNextHookEx( g_DXUTState.GetKeyboardHook(), nCode, wParam, lParam); 
	}
	...
	case WM_KEYUP:    
		{
			...
			{
				::SendMessage(DXUTGetHWND(), WM_COMMAND, VK_F2, NULL);
			}
			break;
		}
	}
    ...
    //    case WM_KEYUP:    
    //    {
    //        bEatKeystroke = ( !g_DXUTState.GetAllowShortcutKeys() && 
...
{
    g_DXUTState.SetAllowShortcutKeysWhenWindowed( bAllowWhenWindowed );
    g_DXUTState.SetAllowShortcutKeysWhenFullscreen( bAllowWhenFullscreen );

    // DXUTInit() records initial accessibility states so don't change them until then
    if( g_DXUTState.GetDXUTInited() )
    {
        if( DXUTIsWindowed() )
            DXUTAllowShortcutKeys( g_DXUTState.GetAllowShortcutKeysWhenWindowed() );
        else
            DXUTAllowShortcutKeys( g_DXUTState.GetAllowShortcutKeysWhenFullscreen() );
    }
}
...
void DXUTAllowShortcutKeys( bool bAllowKeys )
{
    g_DXUTState.SetAllowShortcutKeys( bAllowKeys );

    if( bAllowKeys )
    {
        // Restore StickyKeys/etc to original state and enable Windows key      
        STICKYKEYS sk = g_DXUTState.GetStartupStickyKeys();
        TOGGLEKEYS tk = g_DXUTState.GetStartupToggleKeys();
        FILTERKEYS fk = g_DXUTState.GetStartupFilterKeys();
        ...
        if( g_DXUTState.GetKeyboardHook() )
        {
            UnhookWindowsHookEx( g_DXUTState.GetKeyboardHook() );
            g_DXUTState.SetKeyboardHook( NULL );
        }                
    }
    else
    {
        // Set low level keyboard hook if haven't already
        if( g_DXUTState.GetKeyboardHook() == NULL )
        {
            ...
            if( OSVersionInfo.dwPlatformId == VER_PLATFORM_WIN32_NT && OSVersionInfo.dwMajorVersion > 4 )
            {
                ...
                g_DXUTState.SetKeyboardHook( hKeyboardHook );
            }
        }
        ...
        STICKYKEYS skOff = g_DXUTState.GetStartupStickyKeys();
        ...
        TOGGLEKEYS tkOff = g_DXUTState.GetStartupToggleKeys();
        ...
        FILTERKEYS fkOff = g_DXUTState.GetStartupFilterKeys();
...
{
    if( g_DXUTState.GetOverrideAdapterOrdinal() != -1 )
        pDeviceSettings->AdapterOrdinal = g_DXUTState.GetOverrideAdapterOrdinal();
    ...
    else if( g_DXUTState.GetOverrideForceHAL() )
        pDeviceSettings->DeviceType = D3DDEVTYPE_HAL;

    if( g_DXUTState.GetOverrideWidth() != 0 )
        pDeviceSettings->pp.BackBufferWidth = g_DXUTState.GetOverrideWidth();
    if( g_DXUTState.GetOverrideHeight() != 0 )
        pDeviceSettings->pp.BackBufferHeight = g_DXUTState.GetOverrideHeight();
...
HRESULT DXUTCreate3DEnvironment( IDirect3DDevice9* pd3dDeviceFromApp )
{
    ...
    DXUTDeviceSettings* pNewDeviceSettings = g_DXUTState.GetCurrentDeviceSettings();
    ...
    g_DXUTState.SetD3DDevice( pd3dDevice );

    // If switching to REF, set the exit code to 11.  If switching to HAL and exit code was 11, then set it back to 0.
    if( pNewDeviceSettings->DeviceType == D3DDEVTYPE_REF && g_DXUTState.GetExitCode() == 0 )
        g_DXUTState.SetExitCode(11);
    else if( pNewDeviceSettings->DeviceType == D3DDEVTYPE_HAL && g_DXUTState.GetExitCode() == 11 )
        g_DXUTState.SetExitCode(0);
    ...
    // Update g_DXUTState's copy of D3D caps 
    D3DCAPS9* pd3dCaps = g_DXUTState.GetCaps();
    ...
    hr = g_CDXUTResourceCache.OnCreateDevice( pd3dDevice );
    if( FAILED(hr) )
    ...
    g_DXUTState.SetInsideDeviceCallback( true );
    LPDXUTCALLBACKDEVICECREATED pCallbackDeviceCreated = g_DXUTState.GetDeviceCreatedFunc();
    hr = S_OK;
    if( pCallbackDeviceCreated != NULL )
        hr = pCallbackDeviceCreated( DXUTGetD3DDevice(), pbackBufferSurfaceDesc, g_DXUTState.GetDeviceCreatedFuncUserContext() );
    g_DXUTState.SetInsideDeviceCallback( false );
    ...
    g_DXUTState.SetDeviceObjectsCreated( true );

    // Call the resource cache device reset function
    hr = g_CDXUTResourceCache.OnResetDevice( pd3dDevice );
    if( FAILED(hr) )
        return DXUT_ERR( L"OnResetDevice", DXUTERR_RESETTINGDEVICEOBJECTS );

    // Call the app's device reset callback if non-NULL
    g_DXUTState.SetInsideDeviceCallback( true );
    LPDXUTCALLBACKDEVICERESET pCallbackDeviceReset = g_DXUTState.GetDeviceResetFunc();
    hr = S_OK;
    if( pCallbackDeviceReset != NULL )
        hr = pCallbackDeviceReset( DXUTGetD3DDevice(), pbackBufferSurfaceDesc, g_DXUTState.GetDeviceResetFuncUserContext() );
    g_DXUTState.SetInsideDeviceCallback( false );
    if( DXUTGetD3DDevice() == NULL ) // Handle DXUTShutdown from inside callback
        return E_FAIL;
    if( FAILED(hr) )
    ...
    g_DXUTState.SetDeviceObjectsReset( true );
...
HRESULT DXUTReset3DEnvironment()
{
    ...
    if( g_DXUTState.GetDeviceObjectsReset() == true )
    {
        g_DXUTState.SetInsideDeviceCallback( true );
        LPDXUTCALLBACKDEVICELOST pCallbackDeviceLost = g_DXUTState.GetDeviceLostFunc();
        if( pCallbackDeviceLost != NULL )
            pCallbackDeviceLost( g_DXUTState.GetDeviceLostFuncUserContext() );
        g_DXUTState.SetDeviceObjectsReset( false );
        g_DXUTState.SetInsideDeviceCallback( false );

        // Call the resource cache device lost function
        g_CDXUTResourceCache.OnLostDevice();
    }

    // Reset the device
 //   DXUTDeviceSettings* pDeviceSettings = g_DXUTState.GetCurrentDeviceSettings();
	//if( pDeviceSettings != NULL )
	//{
    ...
    hr = S_OK;
    if( pCallbackDeviceReset != NULL )
        hr = pCallbackDeviceReset( pd3dDevice, pbackBufferSurfaceDesc, g_DXUTState.GetDeviceResetFuncUserContext() );
    g_DXUTState.SetInsideDeviceCallback( false );
    if( FAILED(hr) )
    {
...
{
    int nPauseTimeCount = g_DXUTState.GetPauseTimeCount();
    nPauseTimeCount += ( bPauseTime ? +1 : -1 );
    if( nPauseTimeCount < 0 )
        nPauseTimeCount = 0;
    g_DXUTState.SetPauseTimeCount( nPauseTimeCount );

    int nPauseRenderingCount = g_DXUTState.GetPauseRenderingCount();
    nPauseRenderingCount += ( bPauseRendering ? +1 : -1 );
    if( nPauseRenderingCount < 0 )
        nPauseRenderingCount = 0;
    g_DXUTState.SetPauseRenderingCount( nPauseRenderingCount );
    ...
    g_DXUTState.SetRenderingPaused( nPauseRenderingCount > 0 );
    g_DXUTState.SetTimePaused( nPauseTimeCount > 0 );
}
...
void DXUTCheckForWindowSizeChange()
{
    ...
    if( g_DXUTState.GetIgnoreSizeChange() || 
        !g_DXUTState.GetDeviceCreated() || 
        !g_DXUTState.GetCurrentDeviceSettings()->pp.Windowed )
        return;

    RECT rcCurrentClient;
    GetClientRect( DXUTGetHWND(), &rcCurrentClient );
    
    if( (UINT)rcCurrentClient.right != g_DXUTState.GetCurrentDeviceSettings()->pp.BackBufferWidth ||
        (UINT)rcCurrentClient.bottom != g_DXUTState.GetCurrentDeviceSettings()->pp.BackBufferHeight )
    {
...
HRESULT DXUTMainLoop( HACCEL hAccel )
{
    ...
    if( g_DXUTState.GetInsideDeviceCallback() || g_DXUTState.GetInsideMainloop() )
    {
        if( (g_DXUTState.GetExitCode() == 0) || (g_DXUTState.GetExitCode() == 11) )
            g_DXUTState.SetExitCode(1);
        return DXUT_ERR_MSGBOX( L"DXUTMainLoop", E_FAIL );
    }

    g_DXUTState.SetInsideMainloop( true );

    // If DXUTCreateDevice*() or DXUTSetDevice() has not already been called, 
    // then call DXUTCreateDevice() with the default parameters.         
    if( !g_DXUTState.GetDeviceCreated() ) 
    {
        if( g_DXUTState.GetDeviceCreateCalled() )
        {
            if( (g_DXUTState.GetExitCode() == 0) || (g_DXUTState.GetExitCode() == 11) )
                g_DXUTState.SetExitCode(1);
    ...
    if( !g_DXUTState.GetDXUTInited() || !g_DXUTState.GetWindowCreated() || !g_DXUTState.GetDeviceCreated() )
    {
        if( (g_DXUTState.GetExitCode() == 0) || (g_DXUTState.GetExitCode() == 11) )
            g_DXUTState.SetExitCode(1);
        return DXUT_ERR_MSGBOX( L"DXUTMainLoop", E_FAIL );
    ...
    g_DXUTState.SetInsideMainloop( false );
...
void DXUTRender3DEnvironment()
{
	...
	try
	{
		if( g_DXUTState.GetDeviceLost() || DXUTIsRenderingPaused() || !DXUTIsActive() )
		{
		...
		if( g_DXUTState.GetDeviceLost() && !g_DXUTState.GetRenderingPaused() )
		{
			...
			g_DXUTState.SetDeviceLost( false );
		}

		// Get the app's time, in seconds. Skip rendering if no time elapsed
		double fTime, fAbsTime; float fElapsedTime;
		g_CDXUTTimer.GetTimeValues( &fTime, &fAbsTime, &fElapsedTime );

		// Store the time for the app
		if( g_DXUTState.GetConstantFrameTime() )
		{        
			fElapsedTime = g_DXUTState.GetTimePerFrame();
			fTime     = DXUTGetTime() + fElapsedTime;
		}

		g_DXUTState.SetTime( fTime );
		g_DXUTState.SetAbsoluteTime( fAbsTime );
		g_DXUTState.SetElapsedTime( fElapsedTime );
		...
		LPDXUTCALLBACKFRAMEMOVE pCallbackFrameMove = g_DXUTState.GetFrameMoveFunc();
		if( pCallbackFrameMove != NULL )
		{
			pCallbackFrameMove( pd3dDevice, fTime, fElapsedTime, g_DXUTState.GetFrameMoveFuncUserContext() );
			pd3dDevice = DXUTGetD3DDevice();
			if( NULL == pd3dDevice ) // Handle DXUTShutdown from inside callback
				return;
		}

		if( !g_DXUTState.GetRenderingPaused() )
		{
			// Render the scene by calling the app's render callback
			LPDXUTCALLBACKFRAMERENDER pCallbackFrameRender = g_DXUTState.GetFrameRenderFunc();
			if( pCallbackFrameRender != NULL )
			{
				pCallbackFrameRender( pd3dDevice, fTime, fElapsedTime, g_DXUTState.GetFrameRenderFuncUserContext() );
				pd3dDevice = DXUTGetD3DDevice();
				if( NULL == pd3dDevice ) // Handle DXUTShutdown from inside callback
					return;
			}
		...
		int nFrame = g_DXUTState.GetCurrentFrameNumber();
		nFrame++;
		g_DXUTState.SetCurrentFrameNumber( nFrame );

		// Check to see if the app should shutdown due to cmdline
		if( g_DXUTState.GetOverrideQuitAfterFrame() != 0 )
		{
			if( nFrame > g_DXUTState.GetOverrideQuitAfterFrame() )
				DXUTShutdown();
		}
	}
	catch (...)
	{
		CHAR	sz[64];
		StringCchPrintfA(sz, 64, "Result: %x", hr);
...
void DXUTUpdateDeviceStats( D3DDEVTYPE DeviceType, DWORD BehaviorFlags, D3DADAPTER_IDENTIFIER9* pAdapterIdentifier )
{
    if( g_DXUTState.GetNoStats() )
        return;

    // Store device description
    WCHAR* pstrDeviceStats = g_DXUTState.GetDeviceStats();
...
void DXUTUpdateFrameStats()
{
    ...
    double fLastTime = g_DXUTState.GetLastStatsUpdateTime();
    DWORD dwFrames  = g_DXUTState.GetLastStatsUpdateFrames();
    double fAbsTime = g_DXUTState.GetAbsoluteTime();
    dwFrames++;
    g_DXUTState.SetLastStatsUpdateFrames( dwFrames );

    // Update the scene stats once per second
    if( fAbsTime - fLastTime > 1.0f )
    {
        float fFPS = (float) (dwFrames / (fAbsTime - fLastTime));
        g_DXUTState.SetFPS( fFPS );
        g_DXUTState.SetLastStatsUpdateTime( fAbsTime );
        g_DXUTState.SetLastStatsUpdateFrames( 0 );

        WCHAR* pstrFPS = g_DXUTState.GetFPSStats();
...
void DXUTUpdateStaticFrameStats()
{
    ...
    WCHAR* pstrStaticFrameStats = g_DXUTState.GetStaticFrameStats();
...
{ 
    WCHAR* pstrFrameStats = g_DXUTState.GetFrameStats();
    WCHAR* pstrFPS = ( bShowFPS ) ? g_DXUTState.GetFPSStats() : L"";
    StringCchPrintf( pstrFrameStats, 256, g_DXUTState.GetStaticFrameStats(), pstrFPS );
...
LRESULT CALLBACK DXUTStaticWndProc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
	LPDXUTCALLBACKMSGPROC pCallbackMsgProc = g_DXUTState.GetWindowMsgFunc();
	bool bNoFurtherProcessing = false;
	LRESULT nResult = pCallbackMsgProc( hWnd, uMsg, wParam, lParam, &bNoFurtherProcessing, g_DXUTState.GetWindowMsgFuncUserContext() );
		...
		uMsg == WM_SYSKEYUP )
	{
		...
		bool* bKeys = g_DXUTState.GetKeys();
		bKeys[ (BYTE) (wParam & 0xFF) ] = bKeyDown;

		LPDXUTCALLBACKKEYBOARD pCallbackKeyboard = g_DXUTState.GetKeyboardFunc();
		if( pCallbackKeyboard )
			pCallbackKeyboard( (UINT)wParam, bKeyDown, bAltDown, g_DXUTState.GetKeyboardFuncUserContext() );           
	}
	...
	if( uMsg == WM_LBUTTONDOWN ||
		...
		uMsg == WM_MOUSEWHEEL || 
		(g_DXUTState.GetNotifyOnMouseMove() && uMsg == WM_MOUSEMOVE) )
	{
		...
		bool* bMouseButtons = g_DXUTState.GetMouseButtons();
		...
		LPDXUTCALLBACKMOUSE pCallbackMouse = g_DXUTState.GetMouseFunc();
		if( pCallbackMouse )
		{
			pCallbackMouse( bLeftButton, bRightButton, bMiddleButton, bSideButton1, bSideButton2, nMouseWheelDelta, xPos, yPos, g_DXUTState.GetMouseFuncUserContext() );
		}
	}
	...
	case WM_PAINT:
		{
			...
			if( pd3dDevice != NULL && DXUTIsRenderingPaused() && 
				g_DXUTState.GetDeviceObjectsCreated() && 
				g_DXUTState.GetDeviceObjectsReset() )
			{
				HRESULT hr = E_FAIL;
	...
	case WM_SIZE:
		if( SIZE_MINIMIZED == wParam )
		{
			...
			g_DXUTState.SetMinimized( true );
			g_DXUTState.SetMaximized( false );
		}
		else
		{
			RECT rcCurrentClient;
			...
			{
				if( g_DXUTState.GetMinimized() )
					DXUTPause( false, false ); // Unpause since we're no longer minimized
				g_DXUTState.SetMinimized( false );
				g_DXUTState.SetMaximized( true );
				DXUTCheckForWindowSizeChange();
				DXUTCheckForWindowChangingMonitors();
			}
			else if( SIZE_RESTORED == wParam )
			{      
				if( g_DXUTState.GetMaximized() )
				{
					g_DXUTState.SetMaximized( false );
					DXUTCheckForWindowSizeChange();
					DXUTCheckForWindowChangingMonitors();
				}
				else if( g_DXUTState.GetMinimized() )
				{
					DXUTPause( false, false ); // Unpause since we're no longer minimized
					g_DXUTState.SetMinimized( false );
					DXUTCheckForWindowSizeChange();
				...
				else if( g_DXUTState.GetInSizeMove() )
				{
	...
	case WM_ENTERSIZEMOVE:
		...
		DXUTPause( true, true );
		g_DXUTState.SetInSizeMove( true );
		break;
	...
	case WM_EXITSIZEMOVE:
		...
		DXUTCheckForWindowSizeChange();
		DXUTCheckForWindowChangingMonitors();
		g_DXUTState.SetInSizeMove( false );
		break;
	...
	case WM_SETCURSOR:
		...
		{
			IDirect3DDevice9* pd3dDevice = DXUTGetD3DDevice();
			if( pd3dDevice && g_DXUTState.GetShowCursorWhenFullScreen() )
	...
	case WM_ACTIVATEAPP:
		if( wParam == TRUE && !DXUTIsActive() ) // Handle only if previously not active 
		{
			...
			if( g_DXUTState.GetMinimizedWhileFullscreen() ) 
			{
				DXUTPause( false, false ); // Unpause since we're no longer minimized
				g_DXUTState.SetMinimizedWhileFullscreen( false );
			}

			// Upon returning to this app, potentially disable shortcut keys 
			// (Windows key, accessibility shortcuts) 
			DXUTAllowShortcutKeys( ( DXUTIsWindowed() ) ? g_DXUTState.GetAllowShortcutKeysWhenWindowed() : 
				g_DXUTState.GetAllowShortcutKeysWhenFullscreen() );

		}
		else if( wParam == FALSE && DXUTIsActive() ) // Handle only if previously active 
		{               
			g_DXUTState.SetActive( false );
			...
			if( !DXUTIsWindowed() )
			{
				...
				g_DXUTState.SetMinimizedWhileFullscreen( true ); 
			}
...
#define PBT_APMRESUMESUSPEND 0x0007
	...
	case PBT_APMRESUMESUSPEND:
		...
		// upon resume.
		g_CDXUTTimer.Reset();                   
		g_DXUTState.SetLastStatsUpdateTime( 0 );
		return true;
		}
		break;
	...
	case WM_SYSKEYDOWN:
		{
			...
			case VK_RETURN:
				{
					if( g_DXUTState.GetHandleAltEnter() )
					{
	...
	case WM_KEYDOWN:
		{
			if( g_DXUTState.GetHandleDefaultHotkeys() )
			{
				;
			}
			break;
	...
	case WM_CLOSE:
		{
			...
			g_DXUTState.SetHWNDFocus( NULL );
			g_DXUTState.SetHWNDDeviceFullScreen( NULL );
			g_DXUTState.SetHWNDDeviceWindowed( NULL );
			return 0;
		}
	...
	if( !g_DXUTState.GetCallDefWindowProc() || g_DXUTState.GetMenu() == NULL && (uMsg == WM_SYSKEYDOWN || uMsg == WM_SYSKEYUP) && wParam == VK_F10 )
		return 0;
...
void DXUTShutdown( int nExitCode )
{
    ...
    g_DXUTState.SetExitCode(nExitCode);
    ...
    g_DXUTState.SetD3DEnumeration( NULL );
    
  /*  IDirect3D9* pD3D = DXUTGetD3DObject();
    SAFE_RELEASE( pD3D );*/
    g_DXUTState.SetD3D( NULL );

    if( g_DXUTState.GetOverrideRelaunchMCE() )
...
void DXUTCleanup3DEnvironment( bool bReleaseSettings )
{
    ...
    if( pd3dDevice != NULL )
    {
        ...
        if( g_DXUTState.GetDeviceObjectsCreated() == true )
        {
            LPDXUTCALLBACKDEVICEDESTROYED pCallbackDeviceDestroyed = g_DXUTState.GetDeviceDestroyedFunc();
            if( pCallbackDeviceDestroyed != NULL )
                pCallbackDeviceDestroyed( g_DXUTState.GetDeviceDestroyedFuncUserContext() );
            g_DXUTState.SetDeviceObjectsCreated( false );

            // Call the resource cache device destory function
            g_CDXUTResourceCache.OnDestroyDevice();
        }
   ...
   //         //}
   //     }
        g_DXUTState.SetD3DDevice( NULL );

        if( bReleaseSettings )
        {
            DXUTDeviceSettings* pOldDeviceSettings = g_DXUTState.GetCurrentDeviceSettings();
            SAFE_DELETE(pOldDeviceSettings);  
            g_DXUTState.SetCurrentDeviceSettings( NULL );
        }

        D3DSURFACE_DESC* pbackBufferSurfaceDesc = g_DXUTState.GetBackBufferSurfaceDesc();
        ZeroMemory( pbackBufferSurfaceDesc, sizeof(D3DSURFACE_DESC) );

        D3DCAPS9* pd3dCaps = g_DXUTState.GetCaps();
        ZeroMemory( pd3dCaps, sizeof(D3DCAPS9) );

        g_DXUTState.SetDeviceCreated( false );
    }
}


//--------------------------------------------------------------------------------------
// Stores back buffer surface desc in g_DXUTState.GetBackBufferSurfaceDesc()
//--------------------------------------------------------------------------------------
void DXUTUpdateBackBufferDesc()
{
    HRESULT hr;
    IDirect3DSurface9* pBackBuffer;
    hr = g_DXUTState.GetD3DDevice()->GetBackBuffer( 0, 0, D3DBACKBUFFER_TYPE_MONO, &pBackBuffer );
    D3DSURFACE_DESC* pBBufferSurfaceDesc = g_DXUTState.GetBackBufferSurfaceDesc();
...
{ 
    ...
    DXUTTimer.nID = g_DXUTState.GetTimerLastID() + 1;
    g_DXUTState.SetTimerLastID( DXUTTimer.nID );

    CGrowableArray<DXUT_TIMER>* pTimerList = g_DXUTState.GetTimerList();
    if( pTimerList == NULL )
    {
        pTimerList = new CGrowableArray<DXUT_TIMER>;
        if( pTimerList == NULL )
            return E_OUTOFMEMORY; 
        g_DXUTState.SetTimerList( pTimerList );
    }
...
//--------------------------------------------------------------------------------------
IDirect3D9* DXUTGetD3DObject()                      { return g_DXUTState.GetD3D(); }        
IDirect3DDevice9* DXUTGetD3DDevice()                { return g_DXUTState.GetD3DDevice(); }  
const D3DSURFACE_DESC* DXUTGetBackBufferSurfaceDesc() { return g_DXUTState.GetBackBufferSurfaceDesc(); }
const D3DCAPS9* DXUTGetDeviceCaps()                 { return g_DXUTState.GetCaps(); }
HINSTANCE DXUTGetHINSTANCE()                        { return g_DXUTState.GetHInstance(); }
HWND DXUTGetHWND()                                  
{ 
	return DXUTIsWindowed() ? g_DXUTState.GetHWNDDeviceWindowed() : g_DXUTState.GetHWNDDeviceFullScreen(); 
}
HWND DXUTGetHWNDFocus()                             { return g_DXUTState.GetHWNDFocus(); }
HWND DXUTGetHWNDDeviceFullScreen()                  { return g_DXUTState.GetHWNDDeviceFullScreen(); }
HWND DXUTGetHWNDDeviceWindowed()                    { return g_DXUTState.GetHWNDDeviceWindowed(); }
RECT DXUTGetWindowClientRect()                      { RECT rc; GetClientRect( DXUTGetHWND(), &rc ); return rc; }
RECT DXUTGetWindowClientRectAtModeChange()          { RECT rc = { 0, 0, g_DXUTState.GetWindowBackBufferWidthAtModeChange(), g_DXUTState.GetWindowBackBufferHeightAtModeChange() }; return rc; }
RECT DXUTGetFullsceenClientRectAtModeChange()       { RECT rc = { 0, 0, g_DXUTState.GetFullScreenBackBufferWidthAtModeChange(), g_DXUTState.GetFullScreenBackBufferHeightAtModeChange() }; return rc; }
double DXUTGetTime()                                { return g_DXUTState.GetTime(); }
float DXUTGetElapsedTime()                          { return g_DXUTState.GetElapsedTime(); }
float DXUTGetFPS()                                  { return g_DXUTState.GetFPS(); }
LPCWSTR DXUTGetWindowTitle()                        { return g_DXUTState.GetWindowTitle(); }
LPCWSTR DXUTGetDeviceStats()                        { return g_DXUTState.GetDeviceStats(); }
bool DXUTIsRenderingPaused()                        { return g_DXUTState.GetPauseRenderingCount() > 0; }
bool DXUTIsTimePaused()                             { return g_DXUTState.GetPauseTimeCount() > 0; }
bool DXUTIsActive()                                 { return g_DXUTState.GetActive(); }
int DXUTGetExitCode()                               { return g_DXUTState.GetExitCode(); }
bool DXUTGetShowMsgBoxOnError()                     { return g_DXUTState.GetShowMsgBoxOnError(); }
bool DXUTGetAutomation()                            { return g_DXUTState.GetAutomation(); }
bool DXUTGetHandleDefaultHotkeys()                  { return g_DXUTState.GetHandleDefaultHotkeys(); }
...
{
    g_DXUTState.SetAutoChangeAdapter( bAutoChangeAdapter );
}
void DXUTSetCursorSettings( bool bShowCursorWhenFullScreen, bool bClipCursorWhenFullScreen ) 
{ 
    g_DXUTState.SetClipCursorWhenFullScreen(bClipCursorWhenFullScreen); 
    g_DXUTState.SetShowCursorWhenFullScreen(bShowCursorWhenFullScreen); 
    DXUTSetupCursor();
}
void DXUTSetWindowSettings( bool bCallDefWindowProc )
{
    g_DXUTState.SetCallDefWindowProc( bCallDefWindowProc );
}
void DXUTSetConstantFrameTime( bool bEnabled, float fTimePerFrame ) 
{ 
    if( g_DXUTState.GetOverrideConstantFrameTime() ) 
    { 
        bEnabled = g_DXUTState.GetOverrideConstantFrameTime(); 
        fTimePerFrame = g_DXUTState.GetOverrideConstantTimePerFrame(); 
    } 
    g_DXUTState.SetConstantFrameTime(bEnabled); 
    g_DXUTState.SetTimePerFrame(fTimePerFrame); 
}
...
{ 
    DXUTDeviceSettings* pDS = g_DXUTState.GetCurrentDeviceSettings(); 
    if( pDS ) 
    {
        return pDS->pp; 
    }
...
void DXUTDisplayErrorMessage( HRESULT hr )
{
    ...
    switch( hr )
    {
        case DXUTERR_NODIRECT3D:             
			nExitCode = 2; 
			StringCchCopy( strBuffer, 512, L"Could not initialize Direct3D. You may want to check that the latest version of DirectX is correctly installed on your system.  Also make sure that this program was compiled with header files that match the installed DirectX DLLs." ); 
			break;
        case DXUTERR_INCORRECTVERSION:       
			nExitCode = 10; 
			StringCchCopy( strBuffer, 512, L"Incorrect version of Direct3D and/or D3DX." ); 
			break;
        case DXUTERR_MEDIANOTFOUND:          
			nExitCode = 4; 
			StringCchCopy( strBuffer, 512, L"Could not find required media. Ensure that the DirectX SDK is correctly installed." ); 
			break;
        case DXUTERR_NONZEROREFCOUNT:        
			nExitCode = 5; 
			StringCchCopy( strBuffer, 512, L"The D3D device has a non-zero reference count, meaning some objects were not released." ); 
			break;
        case DXUTERR_CREATINGDEVICE:         
			nExitCode = 6; StringCchCopy( strBuffer, 512, L"Failed creating the Direct3D device." ); 
			break;
        case DXUTERR_RESETTINGDEVICE:        
			nExitCode = 7; StringCchCopy( strBuffer, 512, L"Failed resetting the Direct3D device." ); 
			break;
        case DXUTERR_CREATINGDEVICEOBJECTS:  
			nExitCode = 8;
			StringCchCopy( strBuffer, 512, L"Failed creating Direct3D device objects." ); 
			break;
        case DXUTERR_RESETTINGDEVICEOBJECTS: 
			nExitCode = 9; StringCchCopy( strBuffer, 512, L"Failed resetting Direct3D device objects." ); 
			break;
    ...
    bool bShowMsgBoxOnError = g_DXUTState.GetShowMsgBoxOnError();
...
void DXUTCheckForWindowChangingMonitors()
{
    ...
    if( !g_DXUTState.GetAutoChangeAdapter() || 
         g_DXUTState.GetIgnoreSizeChange() ||
        !g_DXUTState.GetDeviceCreated() ||
        !g_DXUTState.GetCurrentDeviceSettings()->pp.Windowed )
    {
        return;
    ...
    HRESULT hr = E_FAIL;
    HMONITOR hWindowMonitor = DXUTMonitorFromWindow( DXUTGetHWND(), MONITOR_DEFAULTTOPRIMARY );
    HMONITOR hAdapterMonitor = g_DXUTState.GetAdapterMonitor();
        ...
        if( SUCCEEDED( DXUTGetAdapterOrdinalFromMonitor( hWindowMonitor, &newOrdinal ) ) )
        {
            ...
            if( SUCCEEDED(hr) ) 
            {
                ...
                if( hr == E_ABORT )
                {
                    ...
                    g_DXUTState.SetAutoChangeAdapter( false );
                }
                else if( FAILED(hr) )
                {
                    DXUTShutdown();
...
void DXUTSetupCursor()
{
    ...
    {
        if( g_DXUTState.GetShowCursorWhenFullScreen() )
        {
    ...
    if( !DXUTIsWindowed() && g_DXUTState.GetClipCursorWhenFullScreen() )
    {
