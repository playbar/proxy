#ifndef IGAIDirect3DDevice9_H
#define IGAIDirect3DDevice9_H
...
class IGAIDirect3DDevice9 : public IDirect3DDevice9
{
public:
    IGAIDirect3DDevice9(IDirect3DDevice9 *pkOriginal);
    virtual ~IGAIDirect3DDevice9();
	...
	HRESULT STDMETHODCALLTYPE GetBackBuffer( UINT iSwapChain,UINT BackBuffer,D3DBACKBUFFER_TYPE Type,IDirect3DSurface9** ppBackBuffer);
    ...
    HRESULT STDMETHODCALLTYPE MultiplyTransform(D3DTRANSFORMSTATETYPE,CONST D3DMATRIX*) ;
    ...
    HRESULT STDMETHODCALLTYPE SetLight(DWORD Index,CONST D3DLIGHT9*) ;
    HRESULT STDMETHODCALLTYPE GetLight(DWORD Index,D3DLIGHT9*) ;
...
public:
	inline  VOID SetFilter(Filter_IDirect3DDevice9*  pFilter)	{		 m_pFilter = pFilter;	}
...
public:	
	typedef std::map<IDirect3DDevice9*,IGAIDirect3DDevice9*>               D3D_DEVICE_MAP; 
	typedef std::map<IDirect3DDevice9*,IGAIDirect3DDevice9*>::iterator     D3D_DEVICE_MAP_IT;
	static  D3D_DEVICE_MAP    s_devices;

	static  IDirect3DDevice9*   GetDevice(IDirect3DDevice9* pDevice)
	{
