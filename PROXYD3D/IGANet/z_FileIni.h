...
class ZFileIni  
{
	enum{ MAX_PATH_ = 256	};
public:
	ZFileIni(LPCTSTR szFileTotalName);
	~ZFileIni();
	...
	BOOL WriteString(LPCTSTR szSection,LPCTSTR szKeyName,LPTSTR szValue );
	BOOL WriteInt   (LPCTSTR szSection,LPCTSTR szKeyName,int nValue );
