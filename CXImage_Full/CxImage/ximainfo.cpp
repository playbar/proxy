...
{
	if (m_bmpHeadInfo.biBitCount<24 && m_stImgInfo.nBkgndIndex>=0) return GetPaletteColor((BYTE)m_stImgInfo.nBkgndIndex);
	return m_stImgInfo.nBkgndColor;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
{
	return m_stImgInfo.nBkgndIndex;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
{
	if (idx<(long)m_bmpHeadInfo.biClrUsed)
		m_stImgInfo.nBkgndIndex = idx;
	else 
		m_stImgInfo.nBkgndIndex = 0;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
{
	rgb.rgbReserved=0;
	m_stImgInfo.nBkgndColor = rgb;
}
////////////////////////////////////////////////////////////////////////////////
bool CxImage::IsTransparent() const
{
	return m_stImgInfo.nBkgndIndex>=0; // <vho>
}
////////////////////////////////////////////////////////////////////////////////
/**
...
{
	return m_bmpHeadInfo.biClrUsed!=0;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
{
	BYTE b = (BYTE)((m_bmpHeadInfo.biBitCount>8) ? 2 /*COLORTYPE_COLOR*/ : 1 /*COLORTYPE_PALETTE*/);
...
void CxImage::SetXDPI(long dpi)
{
	...
	m_stImgInfo.xDPI = dpi;
	m_bmpHeadInfo.biXPelsPerMeter = (long) floor(dpi * 10000.0 / 254.0 + 0.5);
	if (m_pDib) ((BITMAPINFOHEADER*)m_pDib)->biXPelsPerMeter = m_bmpHeadInfo.biXPelsPerMeter;
}
////////////////////////////////////////////////////////////////////////////////
/**
 * Set resolution for TIFF, JPEG, PNG and BMP formats.
...
{
	if (dpi<=0) dpi = CXIMAGE_DEFAULT_DPI;
	m_stImgInfo.yDPI = dpi;
	m_bmpHeadInfo.biYPelsPerMeter = (long) floor(dpi * 10000.0 / 254.0 + 0.5);
	if (m_pDib) ((BITMAPINFOHEADER*)m_pDib)->biYPelsPerMeter = m_bmpHeadInfo.biYPelsPerMeter;
}
////////////////////////////////////////////////////////////////////////////////
/**
 * \sa SetFlags
...
{
	if (bLockReservedFlags) m_stImgInfo.dwFlags = flags & 0x0000ffff;
	else m_stImgInfo.dwFlags = flags;
}
////////////////////////////////////////////////////////////////////////////////
/**
 * \sa SetCodecOption
...
DWORD CxImage::GetCodecOption(DWORD imagetype)
{
	...
	return m_stImgInfo.dwCodecOpt[imagetype];
}
////////////////////////////////////////////////////////////////////////////////
/**
...
bool CxImage::SetCodecOption(DWORD opt, DWORD imagetype)
{
	...
	m_stImgInfo.dwCodecOpt[imagetype] = opt;
	return true;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
{
	return m_bmpHeadInfo.biHeight;
}
////////////////////////////////////////////////////////////////////////////////
DWORD CxImage::GetWidth() const
{
	return m_bmpHeadInfo.biWidth;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
{
	return m_bmpHeadInfo.biClrUsed;
}
////////////////////////////////////////////////////////////////////////////////
/**
 * \return: 1, 4, 8, 24.
...
{
	return m_bmpHeadInfo.biBitCount;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
#endif
		m_stImgInfo.dwType = type;
		return true;
	}
	m_stImgInfo.dwType = CXIMAGE_FORMAT_UNKNOWN;
	return false;
}
////////////////////////////////////////////////////////////////////////////////
...
{
	return m_stImgInfo.dwFrameDelay;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
{
	m_stImgInfo.dwFrameDelay=d;
}
////////////////////////////////////////////////////////////////////////////////
void CxImage::GetOffset(long *x,long *y)
{
	*x=m_stImgInfo.xOffset;
	*y=m_stImgInfo.yOffset;
}
////////////////////////////////////////////////////////////////////////////////
void CxImage::SetOffset(long x,long y)
{
	m_stImgInfo.xOffset=x;
	m_stImgInfo.yOffset=y;
}
////////////////////////////////////////////////////////////////////////////////
/**
...
{
	return (BYTE)(m_stImgInfo.fQuality + 0.5f);
}
////////////////////////////////////////////////////////////////////////////////
/**
...
void CxImage::SetJpegQualityF(float q){
	if (q>0) m_stImgInfo.fQuality = q;
	else  m_stImgInfo.fQuality = 0.0f;
}
////////////////////////////////////////////////////////////////////////////////
/**
 * \sa SetJpegScale
...
{	return m_stImgInfo.dispmeth; }
////////////////////////////////////////////////////////////////////////////////
bool CxImage::GetRetreiveAllFrames() const
{	return m_stImgInfo.bGetAllFrames; }
////////////////////////////////////////////////////////////////////////////////
void CxImage::SetRetreiveAllFrames(bool flag)
{	m_stImgInfo.bGetAllFrames = flag; }
////////////////////////////////////////////////////////////////////////////////
CxImage * CxImage::GetFrame(long nFrame) const
{
	if ( m_ppFrames == NULL) return NULL;
	if ( m_stImgInfo.nNumFrames == 0) return NULL;
	if ( nFrame >= m_stImgInfo.nNumFrames ) return NULL;
	if ( nFrame < 0) nFrame = m_stImgInfo.nNumFrames - 1;
	return m_ppFrames[nFrame];
}
////////////////////////////////////////////////////////////////////////////////
short CxImage::ntohs(const short word)
{
	if (m_stImgInfo.bLittleEndianHost) return word;
	return ( (word & 0xff) << 8 ) | ( (word >> 8) & 0xff );
}
////////////////////////////////////////////////////////////////////////////////
long CxImage::ntohl(const long dword)
{
	if (m_stImgInfo.bLittleEndianHost) return dword;
...
{
	return m_stImgInfo.szLastError;
}
////////////////////////////////////////////////////////////////////////////////
DWORD CxImage::DumpSize()
{
	...
	if (m_pAlpha){
		n += 1 + m_bmpHeadInfo.biWidth * m_bmpHeadInfo.biHeight;
	} else n++;
...
DWORD CxImage::Dump(BYTE * dst)
{
	...
	memcpy(dst,&m_bmpHeadInfo,sizeof(BITMAPINFOHEADER));
	dst += sizeof(BITMAPINFOHEADER);

	memcpy(dst,&m_stImgInfo,sizeof(CXIMAGEINFO));
	dst += sizeof(CXIMAGEINFO);

	memcpy(dst,m_pDib,GetSize());
	dst += GetSize();

	if (m_pAlpha){
		memset(dst++, 1, 1);
		memcpy(dst,m_pAlpha,m_bmpHeadInfo.biWidth * m_bmpHeadInfo.biHeight);
		dst += m_bmpHeadInfo.biWidth * m_bmpHeadInfo.biHeight;
	} else {
		memset(dst++, 0, 1);
	}
	...
	if (m_pSelection){
		memset(dst++, 1, 1);
		memcpy(dst,m_pSelection,m_bmpHeadInfo.biWidth * m_bmpHeadInfo.biHeight);
		dst += m_bmpHeadInfo.biWidth * m_bmpHeadInfo.biHeight;
	} else {
		memset(dst++, 0, 1);
	}
...
DWORD CxImage::UnDump(const BYTE * src)
{
	...
	memcpy(&m_bmpHeadInfo,src,sizeof(BITMAPINFOHEADER));
	n += sizeof(BITMAPINFOHEADER);

	memcpy(&m_stImgInfo,&src[n],sizeof(CXIMAGEINFO));
	n += sizeof(CXIMAGEINFO);

	if (!Create(m_bmpHeadInfo.biWidth, m_bmpHeadInfo.biHeight, m_bmpHeadInfo.biBitCount, m_stImgInfo.dwType))
		return 0;

	memcpy(m_pDib,&src[n],GetSize());
	n += GetSize();

	if (src[n++]){
		if (AlphaCreate()){
			memcpy(m_pAlpha, &src[n], m_bmpHeadInfo.biWidth * m_bmpHeadInfo.biHeight);
		}
		n += m_bmpHeadInfo.biWidth * m_bmpHeadInfo.biHeight;
	}

	if (src[n++]){
		RECT box = m_stImgInfo.rSelectionBox;
		if (SelectionCreate()){
			m_stImgInfo.rSelectionBox = box;
			memcpy(m_pSelection, &src[n], m_bmpHeadInfo.biWidth * m_bmpHeadInfo.biHeight);
		}
		n += m_bmpHeadInfo.biWidth * m_bmpHeadInfo.biHeight;
	}

	if (src[n++]){
		m_ppLayers = new CxImage*[m_stImgInfo.nNumLayers];
		for (long m=0; m<GetNumLayers(); m++){
			m_ppLayers[m] = new CxImage();
			n += m_ppLayers[m]->UnDump(&src[n]);
		}
	}

	if (src[n++]){
		m_ppFrames = new CxImage*[m_stImgInfo.nNumFrames];
		for (long m=0; m<GetNumFrames(); m++){
			m_ppFrames[m] = new CxImage();
			n += m_ppFrames[m]->UnDump(&src[n]);
		}
	}
