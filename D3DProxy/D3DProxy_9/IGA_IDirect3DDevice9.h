...
#define D3DFVF_CUSTOMVERTEX (D3DFVF_XYZRHW|D3DFVF_DIFFUSE)  //∂•µ„∏Ò Ω

class IGA_IDirect3DDevice9 : public IDirect3DDevice9
{
public:
    IGA_IDirect3DDevice9(IDirect3DDevice9* pOriginal);
    virtual ~IGA_IDirect3DDevice9(void);
