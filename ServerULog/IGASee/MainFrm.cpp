...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	this->SetWindowText(_T("ServerU日志查看工具"));
...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	TVisualObject *pTab = new TVisualObject(1,"Test",pContext,RUNTIME_CLASS(TTabWnd), TVisualObject::TOS_TABTOP);
	TVisualObject *pTabViewSplite = new TVisualObject(2,_T("ServerU日志"),1,2,pContext);
