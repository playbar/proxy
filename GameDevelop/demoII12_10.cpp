...
// draw title
Draw_Text_GDI("Press <RIGHT>/<LEFT> arrows to change texture.",10, ty,RGB(255,255,255), lpddsback);
Draw_Text_GDI("Press <UP>/<DOWN> arrows to change mipmap gamma factor.",10,ty+=16,RGB(255,255,255), lpddsback);
Draw_Text_GDI("<ESC> to Exit. ",10, ty+=16,RGB(255,255,255), lpddsback);
