...
OBJECT4DV2_PTR  obj_flat_work;
OBJECT4DV2_PTR  obj_gouraud_work;

OBJECT4DV2  obj_constant_array[NUM_OBJECTS]; // array of objects
OBJECT4DV2  obj_flat_array[NUM_OBJECTS];
OBJECT4DV2  obj_gouraud_array[NUM_OBJECTS];

int curr_constant_object = 0;  // the current object of each class
int curr_flat_object     = 0;
int curr_gouraud_object  = 0;
