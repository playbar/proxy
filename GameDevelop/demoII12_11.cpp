...
if (keyboard_state[DIK_1])
   ...
   Wait_Clock(1); // wait, so keyboard doesn't bounce
   } // end if
...
if (help_mode==1)
    ...
    Draw_Text_GDI("<B>..............Toggle Bilinear Filtering.", 0, text_y+=12, RGB(255,255,255), lpddsback);
    Draw_Text_GDI("<M>..............Toggle Mip Mapping.", 0, text_y+=12, RGB(255,255,255), lpddsback);
    Draw_Text_GDI("<1>, <2>.........Decrease/Increase Mipdistance.", 0, text_y+=12, RGB(255,255,255), lpddsback);
...
Draw_Text_GDI(work_string, 0, WINDOW_HEIGHT-34-32, RGB(0,255,0), lpddsback);

sprintf(work_string,"CAM [%5.2f, %5.2f, %5.2f]",  cam.pos.x, cam.pos.y, cam.pos.z);
Draw_Text_GDI(work_string, 0, WINDOW_HEIGHT-34-48, RGB(0,255,0), lpddsback);
