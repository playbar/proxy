...
int Game_Main(void *parms)
{
	...
	face1.tvlist[0].x = 1;
	face1.tvlist[0].y = 1;
	face1.lit_color[0] = RGB16Bit(255,0,0);

	face1.tvlist[1].x = 400;
	face1.tvlist[1].y = 1;
	face1.lit_color[1] = RGB16Bit(0,255,0);

	face1.tvlist[2].x = 400;
	face1.tvlist[2].y = 400;
	face1.lit_color[2] = RGB16Bit(0,0,255);
	face1.prev = face1.next = NULL;
	face1.texture = new BITMAP_IMAGE_TYP();
