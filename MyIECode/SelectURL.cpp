...
void CSelectURL::LoadClosed()
{
	...
	{
		m_list.InsertItem(0, pmf->m_strUndoName[nCur],9);
...
BOOL CSelectURL::OnInitDialog() 
{
	...
	CImageList img;
	img.Create(11, 16, ILC_COLORDDB|ILC_MASK, 10,1);
	HBITMAP hbmp = pmf->GetBitmap("TaskBar.bmp");
