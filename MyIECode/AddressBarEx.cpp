...
/////////////////////////////////////////////////////////////////////////////
// CAddressBarEx
LRESULT CAddressBarEx::DefWindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	if(message == TB_GETBUTTON || message == TB_DELETEBUTTON || message == TB_INSERTBUTTON)
	{
		CToolBar::DefWindowProc(message, wParam, lParam);
		return	TRUE;
	}
...
//===
	...
	if(IsWindow(m_wndAddress.GetSafeHwnd()))
	{
